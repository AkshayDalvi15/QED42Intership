...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 04, 2021 at 06:34 AM
...
INSERT INTO `comment` (`comment_id`, `post_id`, `user_id`, `comment_desc`) VALUES
(2, 8, 2, 'very good'),
(3, 8, 2, 'superb'),
(4, 8, 2, 'superb'),
(5, 8, 2, 'good'),
(6, 8, 2, 'good'),
(9, 8, 2, 'good'),
(12, 2, 2, 'beautiful book'),
(15, 2, 2, 'beautiful book'),
(17, 12, 2, 'nice content'),
(18, 12, 2, 'nice content'),
(20, 12, 2, 'good'),
(21, 2, 9, 'fantastic book'),
(22, 2, 2, 'nice content'),
(23, 12, 9, 'Nice content'),
(24, 10, 2, 'Nice blog'),
(25, 3, 11, 'beautiful book'),
(26, 13, 9, 'Good post'),
(27, 13, 9, 'fantastic');
...
(13, 9, 'Drupal 9', 0, 'Drupal9.jpg', '&lt;p&gt;Drupal 9 is a cleaned-up version of Drupal 8. It is the same as the last Drupal 8 minor version with our own deprecated code removed and third-party dependencies updated. Most extensions will only need a few changes.&amp;nbsp;Read more about how this is done and what it means.&lt;/p&gt;\r\n\r\n&lt;p&gt;&amp;nbsp;Drupal 8.9 is a long-term support version that will be supported until November 2021, with no new feature development (whereas Drupal 9 development and support will continue beyond that date). Drupal 8.9 has most of the changes that Drupal 9 does, but retains backwards compatibility layers added through Drupal 8&amp;#39;s release, and is a good choice to update to first if you have an existing Drupal site, to ensure maximum compatibility and the smallest necessary changes for the Drupal 9 update.&lt;/p&gt;\r\n\r\n&lt;p&gt;If you are starting a new Drupal 9 project, you have a choice between Drupal 8.9 and 9.0, and generally want to choose Drupal 9.0 for forward compatibility with later releases.&lt;/p&gt;\r\n\r\n&lt;p&gt;Lets beginning the journey of website development using drupal 9.&lt;/p&gt;\r\n\r\n&lt;p&gt;&amp;nbsp;&lt;/p&gt;\r\n', '2021-09-28 05:17:08', '2021-10-01 04:42:39'),
(14, 11, 'Kedarnath Temple', 0, 'kedarnath.jpg', '&lt;p&gt;One of the most revered temple destinations of India, Kedarnath town is nestled in the mighty Garhwal Himalayas. The town, built around the revered Kedarnath temple, is located at an altitude of 3,580 m, near Chorabari glacier, which is the source of the Mandakini river. Dedicated to Lord Shiva, the ancient temple has exquisite architecture and is built of extremely large but evenly shaped grey stone slabs. A conical rock formation inside the temple is worshipped as Lord Shiva in his &amp;ldquo;Sadashiva&amp;rdquo; form.&amp;nbsp; The Kedarnath temple, dedicated to Lord Shiva and is one of the 12 Jyotirlingas of Lord Shiva in India. Behind the Kedarnath temple, stand the Kedarnath peak, Kedar Dome and other Himalayan peaks.&lt;/p&gt;\r\n\r\n&lt;p&gt;The historical name of this region is &amp;quot;Kedar Khand&amp;quot; and legend says, the Pandavas from the epic Mahabharata, after having defeated the Kauravas, felt guilty of having killed so many people and sought the blessings of Lord Shiva for redemption. The Lord eluded them repeatedly and took refuge at Kedarnath in the form of a bull. The Lord dived into the ground, leaving his hump on the surface at Kedarnath. The remaining portions of Lord Shiva appeared at four other places and are worshipped there as his manifestations. The arms of the Lord appeared at Tungnath, the face at Rudranath, the belly at Madmaheshwar and his locks (hair) at Kalpeshwar.&lt;/p&gt;\r\n\r\n&lt;p&gt;&amp;nbsp;&lt;/p&gt;\r\n', '2021-09-28 07:19:22', '2021-09-28 07:19:22'),
(15, 11, 'GitHub', 0, 'GitHub.png', '&lt;p&gt;GitHub is a web-based version-control and collaboration platform for software developers.&amp;nbsp;Microsoft, the biggest single contributor to GitHub, initiated an acquisition of GitHub&amp;nbsp;for $7.5 billion in June, 2018.&lt;/p&gt;\r\n\r\n&lt;p&gt;Three important terms used by developers in GitHub are fork, pull request and merge. A&amp;nbsp;&lt;em&gt;fork, &lt;/em&gt;also known as a&lt;em&gt; branch,&lt;/em&gt;&amp;nbsp;is simply a repository that has been copied from one member&amp;#39;s account to another member&amp;#39;s account. Forks and branches allow a developer to make modifications without affecting the original code. If the developer would like to share the modifications, she can send a&amp;nbsp;&lt;em&gt;pull request&lt;/em&gt;&amp;nbsp;to the owner of the original repository. If, after reviewing the modifications, the original owner would like to pull the modifications into the repository, she can accept the modifications and&amp;nbsp;&lt;em&gt;merge&lt;/em&gt;&amp;nbsp;them with the original repository. Commits are, by default, all retained and interleaved onto the master project, or can be combined into a simpler merge via commit squashing. Because GitHub is so intuitive to use and its version-control tools are so useful for collaboration, nonprogrammers have also begun to use GitHub to work on document-based and multimedia projects.&lt;/p&gt;\r\n', '2021-09-28 07:28:36', '2021-09-28 07:44:33');
...
(6, 9, 'Ravi', 'Mahajan', 9988543210, 'Aurux society, kharadi bypass, pune', 'Front Developer'),
(7, 11, 'Omkar', 'Deshpande', 9665366893, 'A/P- Padhegaon, Tal- Shrirampur, Dist- Ahmednagar', 'Drupal Developer in QED42.');
...
(4, 'pravinG', 'pravinG@tmail.com', 'Admin', 'c1533b9eb43a46071199feec131c5fde', '2021-08-11 07:14:58', '2021-08-11 07:14:58'),
...
(9, 'RaviMahajan', 'mahajan.ravi12345@gmail.com', 'Author', '1790f19d6edb09a7a94870e99c7b0689', '2021-09-12 13:30:21', '2021-09-12 13:30:21'),
(11, 'omkardeshpande', 'omkardeshpande95@gmail.com', 'Author', '68115705108ddd6f7ba9a458bb175363', '2021-09-26 14:26:01', '2021-09-26 14:26:01'),
(12, 'john', 'john@gmail.com', NULL, '527bd5b5d689e2c32ae974c6229ff785', '2021-10-01 04:28:41', '2021-10-01 04:28:41');
